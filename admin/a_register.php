            ...
            <div class="p-5">
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno; ?>" placeholder="Enter Phone Number (e.g., 254712345678)" required>
                  </div>
