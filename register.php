            ...
            <div class="p-5">
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno1; ?>" placeholder="Phone Number 1 e.g; 254717******" required>
                  </div>
                </div>
                <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-user" name="pno2" value="<?php echo @$pno2; ?>" placeholder="Phone Number 2 e.g; 254717******" required>
                </div>
                <div class="col-sm-6">
                ...
                <div class="form-group">
                  <iframe src="contract.pdf" width="100%" height="500px" style="border: none;border-radius:20px;"></iframe>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno1" value="<?php echo @$cpno1; ?>" placeholder="Phone Number 1 e.g; 254717******" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno2" value="<?php echo @$cpno2; ?>" placeholder="Phone Number 1 e.g; 254717******" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno3" value="<?php echo @$cpno3; ?>" placeholder="Phone Number 2 e.g; 254717******">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno4" value="<?php echo @$cpno4; ?>" placeholder="Phone Number 2 e.g; 254717******">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
