    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Please contact the system administrator for any changes concerning your contract. Thank you!<br/><br/><b>Phone Number: +254 (0) 756 777 777.<br/>Email Address: rhms123@hotmail.com.</p>
        </div>
        <!-- /.container-fluid -->
